...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Huanmao@maoioi.onmicrosoft.com',
  ...
  email: 'Aiaiioi@maoioi.onmicrosoft.com',
  ...
  links: [
    {
      name: '笔记',
      link: 'https://aiaiioi.gitee.io/',
    },
    {
      name: '笔记',
      link: 'https://aiaiioi.pages.dev/',
    },
  ],
